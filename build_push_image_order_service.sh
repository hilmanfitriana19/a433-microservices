# build docker image
docker build -t hilmanfitriana19/order_service:latest .
...
docker tag hilmanfitriana19/order_service:latest ghcr.io/hilmanfitriana19/order_service:latest
docker push ghcr.io/hilmanfitriana19/order_service:latest